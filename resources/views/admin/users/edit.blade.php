...
<div class="max-w-3xl relative">
    ...
    <!-- Page Title -->
    <h1 class="page-title mb-8 fade-in">Edit User</h1>

    <!-- Info Badge -->
    <div class="info-badge fade-in">
        <p class="info-text">Update user account details and settings</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    @error('password')
                        <p class="error-message">⚠️ {{ $message }}</p>
                    @enderror
                    <p class="handwritten text-sm text-gray-600 mt-1">💡 Leave empty to keep current password</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p class="handwritten text-sm text-gray-600 mt-1">🔐 Must match if changing</p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                @error('role')
                    <p class="error-message">⚠️ {{ $message }}</p>
                @enderror
                <p class="handwritten text-base text-gray-600 mt-2">⚠️ Be careful when assigning admin privileges</p>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="bio" 
                          id="bio" 
                          class="graffiti-textarea">{{ old('bio', $user->bio) }}</textarea>
                @error('bio')
                    <p class="error-message">⚠️ {{ $message }}</p>
                @enderror
            </div>
    ...
    <div class="mt-8 fade-in delay-1">
        <div style="background: white; border: 3px dashed #000; border-radius: 16px; padding: 24px;">
            <h3 class="doodle-text text-xl mb-4" style="color: var(--dark-bg);">📊 User Stats:</h3>
